...
docker run -d -p 9200:9200 -p 9300:9300 -v /home/gio/projects/malwords_search/elasticsearch.yml:/usr/share/elasticsearch/config/elasticsearch.yml -e ES_JAVA_OPTS="-Xms8g -Xmx8g" --name=elasticsearch1 elasticsearch
